...
export function FloatingContactButtons() {
    ...
    return (
        <div className="fixed bottom-8 sm:bottom-12 end-4 sm:end-6 z-50 flex flex-col gap-2 sm:gap-3">
            {/* WhatsApp Button */}
            <button
                onClick={handleWhatsAppClick}
                onMouseEnter={() => setIsHovered('whatsapp')}
                onMouseLeave={() => setIsHovered(null)}
                className="group relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 overflow-visible"
            ...
            <button
                ...
                onMouseLeave={() => setIsHovered(null)}
                className="group relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95"
