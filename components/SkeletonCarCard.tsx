...
export function SkeletonCarCard() {
    return (
        <div className="bg-card rounded-[24px] overflow-hidden border border-white/5 shadow-md flex flex-col h-full relative">
            ...
            <div className="p-6 flex flex-col flex-grow space-y-4">
                ...
                <div className="mt-auto pt-4 space-y-4">
                    <div>
                        <div className="h-3 bg-white/5 rounded-md w-20 mb-2"></div>
                        <div className="h-8 bg-white/10 rounded-md w-32"></div>
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                        <div className="h-12 bg-primary/20 rounded-xl w-full"></div>
