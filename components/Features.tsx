                ...
                >
                    {features.map((feature, idx) => (
                        <motion.div
                            ...
                            className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-card border border-border/50 shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
                        >
                            <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 text-primary">
                                <feature.icon className="h-7 w-7" />
                            </div>
                            <h3 className="text-base sm:text-2xl font-bold mb-2 sm:mb-3">{feature.title}</h3>
                            <p className="text-muted-foreground text-[10px] sm:text-base leading-relaxed line-clamp-2">
                                {feature.desc}
                            </p>
                        </motion.div>
                    ))}
