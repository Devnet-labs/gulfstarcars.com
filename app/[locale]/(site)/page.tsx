  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen min-h-[700px] flex flex-col justify-center bg-background">
        ...
        <div className="container relative z-10 px-4 h-full flex flex-col justify-center pb-20">
          <motion.div
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-0 right-0 z-50 px-4"
        >
          <div className="container mx-auto px-4 relative z-50 -mt-20">
            <Link href="/cars">
              <motion.div
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.98 }}
                className="relative group max-w-3xl mx-auto cursor-pointer"
              >
                <div className="bg-card/90 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-white/10 shadow-xl">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {t('cta.browseSubtitle')}
                        </p>
                      </div>
                    </div>

                    {/* Right CTA Button */}
                    <div className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-xl transition-all duration-300 group-hover:gap-3">
                      <span className="font-semibold">{t('cta.viewAllCars')}</span>
          ...
          {loadingCars ? (
            ...
            <>
              ...
              <div className="mt-8 text-center">
                <Link href="/cars" className="inline-flex items-center text-primary font-bold hover:underline group">
                  {t('carsOfDay.viewAll')} <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Link>
              </div>
            </>
          )}
